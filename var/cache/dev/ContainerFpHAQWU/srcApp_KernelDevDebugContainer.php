...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderd051e = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer9f4f5 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesb983c = [
        
    ];

    public function getConnection()
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'getConnection', array(), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'getMetadataFactory', array(), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'getExpressionBuilder', array(), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'beginTransaction', array(), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'getCache', array(), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->getCache();
    }

    public function transactional($func)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'transactional', array('func' => $func), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->transactional($func);
    }

    public function commit()
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'commit', array(), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->commit();
    }

    public function rollback()
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'rollback', array(), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'getClassMetadata', array('className' => $className), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'createQuery', array('dql' => $dql), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'createNamedQuery', array('name' => $name), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'createQueryBuilder', array(), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'flush', array('entity' => $entity), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'clear', array('entityName' => $entityName), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->clear($entityName);
    }

    public function close()
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'close', array(), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->close();
    }

    public function persist($entity)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'persist', array('entity' => $entity), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'remove', array('entity' => $entity), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'refresh', array('entity' => $entity), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'detach', array('entity' => $entity), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'merge', array('entity' => $entity), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'getRepository', array('entityName' => $entityName), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'contains', array('entity' => $entity), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'getEventManager', array(), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'getConfiguration', array(), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'isOpen', array(), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'getUnitOfWork', array(), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'getProxyFactory', array(), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'initializeObject', array('obj' => $obj), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'getFilters', array(), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'isFiltersStateClean', array(), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'hasFilters', array(), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return $this->valueHolderd051e->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer9f4f5 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderd051e) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderd051e = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderd051e->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, '__get', ['name' => $name], $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        if (isset(self::$publicPropertiesb983c[$name])) {
            return $this->valueHolderd051e->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderd051e;
    ...
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;
    ...
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, '__isset', array('name' => $name), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;
    ...
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, '__unset', array('name' => $name), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;
    ...
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, '__clone', array(), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        $this->valueHolderd051e = clone $this->valueHolderd051e;
    }

    public function __sleep()
    {
        $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, '__sleep', array(), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;

        return array('valueHolderd051e');
    }
    ...
    {
        $this->initializer9f4f5 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer9f4f5;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer9f4f5 && ($this->initializer9f4f5->__invoke($valueHolderd051e, $this, 'initializeProxy', array(), $this->initializer9f4f5) || 1) && $this->valueHolderd051e = $valueHolderd051e;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderd051e;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderd051e;
    }
}
